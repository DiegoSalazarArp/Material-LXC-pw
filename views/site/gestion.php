...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="<?= Url::toRoute(['site/createprod']) ?>"><button class="btn btn-fill-out btn-block">Crear Productos</button></a>
        </div>
        <div class="col-md-3">
            <a href="<?= Url::toRoute(['site/cat']) ?>"><button class="btn btn-fill-out btn-block">Crear Categorias</button></a>
        </div>
   
        <div class="col-md-2">
            <a href="<?= Url::toRoute(['site/variantes']) ?>"><button class="btn btn-fill-out btn-block">Variantes</button></a>
        </div>
        <div class="col-md-2">
            <a href="<?= Url::toRoute(['site/slider']) ?>"><button class="btn btn-fill-out btn-block">Slider</button></a>
        </div>
        <div class="col-md-2">
            <a href="<?= Url::toRoute(['site/estadisticas']) ?>"><button class="btn btn-fill-out btn-block">Estadisticas</button></a>
        </div>
    </div>
    <br>
    <div class="row">
